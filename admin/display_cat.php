...
<?php include_once('includes/header_end.php'); ?>
                            ...
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="hide-phone list-inline-item app-search">
                                    <h3 class="page-title">Game list</h3>
                                </li>
                            </ul>
                                ...
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Display Game</h4>
                                            ...
                                            while($r_banner = mysqli_fetch_array($fe_banner)){ 
                                                ...
                                                <tr class="delete_mem<?php echo $id ?>">
                                                    ...
                                                    <td>  <?php echo $name;?></td>
                                                    <td><img src="upload/cat/<?php  echo $r_banner['image'];?>" alt="imges" width="100px"></td>
                                                    <td> 
                                                    <div>
                                                        <a href="update_category.php?uid=<?php echo $r_banner['id'];?>"><i class="fa fa-edit fa-2x" style="color: info ;"></i>
                                                    </a>
