            ...
            <div class="left side-menu">
                ...
                <div class="topbar-left">
                    <div class="">
                        ...
                        <a href="index.php" class="logo"><img src="assets/images/logo1.jpg" height="100" alt="logo"></a>
                    </div>
                </div>
                ...
                <div class="sidebar-inner slimscrollleft">
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="home.php" class="waves-effect"><i class="dripicons-device-desktop"></i><span> Dashboard </span></a>
                            </li>
                            
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-mail"></i> <span> Game <span class="float-right"><i class="mdi mdi-chevron-right"></i></span> </span> </a>
                                <ul class="list-unstyled">
                                    <li><a href="add_category.php">Add Game</a></li>
                                    <li><a href="display_cat.php">Display Game</a></li>
                                    <!-- <li><a href="email-compose.php">Email Compose</a></li> -->
                                </ul>
                            </li>
                        
                            <!-- <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-mail"></i> <span> sub category <span class="float-right"><i class="mdi mdi-chevron-right"></i></span> </span> </a>
                                <ul class="list-unstyled">
                                    <li><a href="add_subcategory.php">Add subcategory</a></li>
                                    <li><a href="display_subcat.php">display subcategory</a></li>
                                </ul>
                            </li> -->
                            
                            <!-- <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-mail"></i> <span>Banner <span class="float-right"><i class="mdi mdi-chevron-right"></i></span> </span> </a>
                                <ul class="list-unstyled">
                                    <li><a href="add_banner.php">Add Banner</a></li>
                                    <li><a href="display_banner.php">display Banner</a></li>
                                </ul>
                            </li> -->
                             <!-- <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-mail"></i> <span>Spinner <span class="float-right"><i class="mdi mdi-chevron-right"></i></span> </span> </a>
                                <ul class="list-unstyled">
                                    <li><a href="add_spinner.php">Add Spinner value</a></li>
                                    <li><a href="display_spinner.php">display Spinner value</a></li>
                                </ul>
                            </li> -->
                             <li>
                                <a href="feedback.php" class="waves-effect"><i class="dripicons-mail"></i><span>Contact </span></a>
                            </li>
                              <li>
                                <a href="payment.php" class="waves-effect"><i class="dripicons-mail"></i><span>Payment </span></a>
                            </li>
                              <li>
                                <a href="logout.php" class="waves-effect"><i class="dripicons-exit text-muted"></i><span> Logout </span></a>
                            </li>
                            <!-- <li class="has_sub">
...
<!-- 
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="advanced-animation.php">Animation</a></li>
                                    <li><a href="advanced-highlight.php">Highlight</a></li>
                                    <li><a href="advanced-rating.php">Rating</a></li>
                                    <li><a href="advanced-nestable.php">Nestable</a></li>
                                    <li><a href="advanced-alertify.php">Alertify</a></li>
                                    <li><a href="advanced-rangeslider.php">Range Slider</a></li>
                                    <li><a href="advanced-sessiontimeout.php">Session Timeout</a></li>
                                </ul>
                            </li> -->
